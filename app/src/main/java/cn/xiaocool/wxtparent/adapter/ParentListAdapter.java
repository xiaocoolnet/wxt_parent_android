...
public class ParentListAdapter extends BaseAdapter {
    ...
    public ParentListAdapter(Context context, ArrayList<ParentInfo> friends){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.tv_name.setText(friends.get(position).getName()+"    ("+friends.get(position).getContent()+")");
