...
import cn.xiaocool.wxtparent.adapter.HeightAdapter;
 ...
 */
public class SpaceClickHeightActivity extends BaseActivity implements View.OnClickListener, NumberPicker.Formatter, NumberPicker.OnValueChangeListener, NumberPicker.OnScrollListener {
    private Context context;
    private RelativeLayout rl_back;
    private TextView btn_input_height;
        ...
        public void handleMessage(android.os.Message msg){
            switch (msg.what){
                case CommunalInterfaces.INPUT_HEIGHT:
                    ...
                    try {
                        ...
                        if (status.equals("success")) {
                            ToastUtils.ToastShort(context, "录入身高数据成功！");
                            getAllInformation();
                        } else {
                            ToastUtils.ToastShort(context, "录入身高失败，请重试！");
                        }
                ...
                case 123:
                    showPopupWindow();
                    break;
                case CommunalInterfaces.GETSTATURE:
                    ...
                    if (obj.optString("status").equals(CommunalInterfaces._STATE)) {
                        ...
                        for (int i = 0; i < hwArray.length(); i++) {
                            ...
                            weight.setWeight(itemObject.optString("stature"));
                        ...
                        if (adapter != null) {
                            ...
                            adapter = new HeightAdapter(context, weights);
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.space_click_height);
        context = this;
        initView();
        weights = new ArrayList<>();
        int type = getIntent().getIntExtra("type_height", 0);
        if (type == 0) {
            handler.sendEmptyMessageDelayed(123,200);
        } else {
            ToastUtils.ToastShort(context, "您今天已经记录过身高了");
        }
        getAllInformation();
    }

    private void getAllInformation() {
        new SpaceRequest(context,handler).getStature();
    }
    ...
    private void initView() {
        ...
        btn_input_height = (TextView) findViewById(R.id.btn_input_height);
        btn_input_height.setOnClickListener(this);
    ...
    private void showPopupWindow() {
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new SpaceRequest(context,handler).InputHeight();
                popupWindow.dismiss();
            }
        });
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.btn_input_height:
                ...
                //IntentUtils.getIntent(SpaceClickWeightActivity.this, SpaceClickInputWeightActivity.class);
                break;
        }
    ...
    private void setChartData() {
        ...
        int[] yValues = new int[]{14, 25, 31, 42, 50};
        for (int i = 0; i < 6; i++) {
            data.addXValue(i + 1, xName[i]);
        }
        for (int i = 0; i < 6; i++) {
            data.addYValue((i + 1) * 10, (i + 1) * 10 + "");
        }
        for (int i = 0; i < 5; i++) {
        ...
        int[] yValues1 = new int[]{13, 28, 30, 45, 49};
        for (int i = 0; i < 5; i++) {
