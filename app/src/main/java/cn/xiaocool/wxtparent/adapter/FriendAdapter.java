...
public class FriendAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.tv_number.setText("共"+friends.get(position).getNumber()+"条成长日记");
        ImageLoader.getInstance().displayImage(NetBaseConstant.NET_CIRCLEPIC_HOST+friends.get(position).getAvator(),holder.iv_avator);
        return convertView;
    }
    class ViewHolder{
