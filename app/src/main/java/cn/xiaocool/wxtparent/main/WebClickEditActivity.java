                ...
                case 122:
                    if (msg.obj!=null){
                        ...
                        if (obj.optString("status").equals("success")){
                            new SpaceRequest(mContext,handler).updateHeadImg(picname, 123);
                            Log.e("pushhead","ok");
                        }else {
                            Log.e("pushhead","not");
                        }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.reset_secert:
                Intent intent1 = new Intent(WebClickEditActivity.this, ForgetPswActivity.class);
...
//                localImgGridAdapter.notifyDataSetChanged();
    ...
    private void resetName(String name) {
        new SpaceRequest(mContext,handler).updateName(name, 124);
    ...
    private void resetSex(int sex) {
        new SpaceRequest(mContext,handler).updateSex(sex, 125);
    }
