 ...
 */
public class FriendDiaryAdapter extends BaseAdapter {
...
//                    intent.putExtra("type", "4");
    ...
    class ViewHolder{
        TextView homework_content,homework_time,teacher_name,homework_item_praise_names,alread_text,not_read_text;
