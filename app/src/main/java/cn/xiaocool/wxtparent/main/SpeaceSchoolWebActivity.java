...
//        }
      /* 幻灯片 */
        ...
        //获取下面列表数据
        new SpaceRequest(getApplicationContext(),handler).getSchoolListInfo("getSchoolNotices", 5);
        new SpaceRequest(getApplicationContext(),handler).getSchoolListInfo("getSchoolNews",6);
        new SpaceRequest(getApplicationContext(),handler).getSchoolListInfo("getParentsThings",7);
    }
