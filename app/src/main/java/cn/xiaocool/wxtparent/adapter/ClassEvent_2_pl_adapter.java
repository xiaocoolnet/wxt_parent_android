 ...
 */
public class ClassEvent_2_pl_adapter extends BaseAdapter {
    ...
    public ClassEvent_2_pl_adapter(Context context, ArrayList<Comments> commentsList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder vh;
        if (convertView == null) {
            convertView = View.inflate(context, R.layout.item_classevent_pinglun, null);
