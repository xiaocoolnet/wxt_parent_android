...
public class RecipeImgGridAdapter extends BaseAdapter {
    ...
    public RecipeImgGridAdapter(ArrayList<String> workImgs, Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        imageLoader.displayImage("http://wxt.xiaocool.net/data/upload/" + mWorkImgs.get(position), viewHolder.imageView,options);
        return convertView;
    }
